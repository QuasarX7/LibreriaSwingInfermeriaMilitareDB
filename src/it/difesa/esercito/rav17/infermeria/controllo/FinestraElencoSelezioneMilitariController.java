...
import it.difesa.esercito.rav17.infermeria.vista.FinestraElencoSelezioneMilitari;
...
public class FinestraElencoSelezioneMilitariController {
    ...
    private boolean caricaTabella() {
        ...
        for(Object[] riga: militari){
            valoriTabella[i][0] = (String)riga[it.difesa.esercito.rav17.infermeria.DaseDati.BASE_DATI.MILITARE.COGNOME];
            valoriTabella[i][1] = (String)riga[it.difesa.esercito.rav17.infermeria.DaseDati.BASE_DATI.MILITARE.NOME];
            valoriTabella[i][2] = ((DataOraria)riga[it.difesa.esercito.rav17.infermeria.DaseDati.BASE_DATI.MILITARE.DATA_NASCITA]).stampaGiorno('/');
            valoriTabella[i][3] = (String)riga[it.difesa.esercito.rav17.infermeria.DaseDati.BASE_DATI.MILITARE.COMPAGNIA];
